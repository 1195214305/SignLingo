        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-teal-600">目标手势</span>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-6 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-stone-500">{currentGesture?.nameEn}</p>
                  </div>
                </div>

                <div className="bg-stone-50 rounded-xl p-4 mb-6">
                  <h3 className="text-sm font-medium text-stone-700 mb-2">动作说明</h3>
                  <p className="text-stone-600">{currentGesture?.description}</p>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-stone-900 mb-4">全部手势</h3>
          ...
          {completedGestures.size === gestures.length && gestures.length > 0 && (
            ...
            >
              ...
              >
                ...
                <h2 className="text-2xl font-bold text-stone-900 mb-2">太棒了!</h2>
